...
int main(){
  ...
  Zoo* noweZoo;
  noweZoo = new Zoo(5);
  noweZoo->add_animal("Nigga",67,3.14,CAT,nullptr);
  noweZoo->add_animal("Balls",13,1.563,DOG,nullptr);
  noweZoo->add_animal("Jas Gews",88,7.6,CAT,3);
  noweZoo->add_animal("Ballin",2,1.13,MONKEY,nullptr);
  noweZoo->add_animal("Moe Lester",21,1.2121,DOG,1);
  noweZoo->add_animal("Ben Dover",0,0,MONKEY,nullptr);
