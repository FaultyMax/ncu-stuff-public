...
Utwórz interfejs Porownywarka, z deklaracja metody porownaj Pojazdy (Pojazd, Pojazd) zwracającej liczbę całkowitą.
Stwórz klasę MaszynaSortujaca, która jako parametr konstruktora przyjmuje obiekt klasy implementującej interfejs Porownywarka. 
MaszynaSortujaca ma posiadać metody
• dodajPojazd(Pojazd),
• sortuj(),
• wypisz().
Dodane pojazdy mają być przechowywane w tablicy.
Metoda sortuj () ma wykorzystywać funkcję porownaj Pojazdy z obiektu przekazanego w konstruktorze klasy MaszynySortujaca.
Stwórz kilka klas implementujących interfejs Porownywarka i użyj ich do sortowania pojazdów
(Samochodów, Rowerów i Łodzi) na podstawie ilości kół, ceny, wagi, ilości miejsc.
